google.charts.load("current", {packages:["timeline"]});
  ...
  function drawChart() {
    ...
    dataTable.addRows([
      ...
      [ 'Workshops', 'AI + Chatbots','AI and Chatbots - Creating Connected Customer Experience by TD', 'TDB', new Date(2018,5,25,23,00), new Date(2018,5,26,0,00), 'Join this talk to discuss industry trends & drivers towards creating engaging human-to-AI agent experiences. Chatbots are changing the way we interact with our customers. For consumers, there\'s a growing interest in chat interactions with companies. One study found that 49 percent of cusomters would prefer to interact with companies via automated methods than any other medium.<br><br><strong>Keywords:</strong> AI and Chatbot technologies, Chatbot & customer service benefits, Bots and humans working together.' ],
      [ 'Workshops', 'AI + Android', 'AI + Android: Make Android Apps more Intelligent using TensorFlow by FDM', 'TDB', new Date(2018,5,26,18,30), new Date(2018,5,26,19,30), 'Interested in Android app development? Make it even more useful using Machine Learning! The aim of this workshop is to learn to embed machine learning into Android apps enabling the apps to be more intelligent.<br><br><strong>Keywords:</strong> Native Android App development, Tensor Flow, Artificial Intelligence, Machine Learning.' ],
