google.charts.load("current", {packages:["timeline"]});
  ...
  function drawChart() {
    ...
    dataTable.addRows([
      [ 'Main Events',  'Early Registration',null,    new Date(2018,5,25,17,00), new Date(2018,5,25,18,00) ],
      [ 'Main Events',  'Registration',null,    new Date(2018,5,25,18,00), new Date(2018,5,25,23,00) ],
      [ 'Food',  'Dinner', 'tooltip',   new Date(2018,5,25,20,30), new Date(2018,5,25,23,30) ],
      [ 'Activities',  'Hacker-Sponsor Mingle',null, new Date(2018,5,25,17,00), new Date(2018,5,25,19,00) ],
      [ 'Workshops', 'Workshop #1',  null, new Date(2018,5,25,23,00), new Date(2018,5,26,0,00) ],
      [ 'Workshops', 'AI + Android Workshop',  null, new Date(2018,5,26,18,30), new Date(2018,5,26,19,30) ],
      [ 'Food',  'Midnight Snack',  null,  new Date(2018,5,26,00,00), new Date(2018,5,26,2,00) ],
      [ 'Food',  'Breakfast',  null,  new Date(2018,5,26,7,00), new Date(2018,5,26,9,00) ], 
      [ 'Food',  'Lunch', null,   new Date(2018,5,26,13,00), new Date(2018,5,26,15,00) ], 
      [ 'Food',  'Dinner',  null,  new Date(2018,5,26,19,00), new Date(2018,5,26,21,30) ], 
      [ 'Food',  'Midnight Snack', null,   new Date(2018,5,27,00,00), new Date(2018,5,27,2,00) ],
    ...
    dataTable.addRows([
      ...
      [ 'Main Events',  'Team Formation', null,   new Date(2018,5,25,21,00), new Date(2018,5,25,22,00) ],
